...
items.addForDay = function(user, item, done) {
  ...
  data.getCollection(items.collections.itemDay, function(e, collection) {
    if(e) {
      return done(e);
    }
...
items.addAllCounts = function(user, item, done) {
  data.getCollection(items.collections.countsAll, function(e, collection) {
    if(e) {
      return done(e);
    }
...
items.addTagCounts = function(user, item, done) {
  ...
  data.getCollection(items.collections.countsTags, function(e, collection) {
    if(e) {
      return done(e);
    }
